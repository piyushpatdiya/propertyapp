...
export class Myrent {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams) {
    ...
    this.list=
    [
    {img: 'assets/img/p1.jpeg', title: '3 BHK, Residential Apartment in Balewadi', address: 'Office No. 501/502, Fortune House,5th fl,Prabhat R , oad, Near Income Tax lane, Erandwane , Pune', pricemarket: '1 crore', price: '71.0 - 74.3 Lac'},
